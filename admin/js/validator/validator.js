...
var validator = (function($){
    ...
    */
    message = {
        ...
        password_repeatt : 'invalid old password',
        password_repeat : 'password does not match',
        repeat          : 'no match',
    ...
    tests = {
        ...
        linke : function(a,b){
            if( b != a ){
                ...
                alertTxt = message[data.type + '_repeatt'] || message.no_match;
                return false;
            }
            return true;
        },
        ...
        */
        ...
        // check if field has any value
            ...
            */
            ...
            if( data.validateLinke ){
                var linkedTo = data['validateLinke'].indexOf('#') == 0 ? $(data['validateLinke']) : $(':input[name=' + data['validateLinke'] + ']');
                data.valid = tests.linke( data.val, linkedTo.val() );
            }
